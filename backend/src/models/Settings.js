...
const Settings = sequelize.define(
  'Settings',
  {
    ...
    currencySymbol: { type: DataTypes.STRING(10), allowNull: false, defaultValue: 'Rs.', field: 'currency_symbol' },
    currencyCode: { type: DataTypes.STRING(10), allowNull: false, defaultValue: 'PKR', field: 'currency_code' },
